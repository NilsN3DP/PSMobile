...
object RemoteSliceClient {
    ...
    fun healthCheck(baseUrl: String, token: String?): Boolean = try {
        ...
        // (Emulator, 15.09.2026: "Verbindung testen" ohne Antwort). Der
        // lange Wert bleibt fuer die eigentlichen Auftraege.
        c.connectTimeout = HEALTH_TIMEOUT_MS
        c.readTimeout = HEALTH_TIMEOUT_MS
