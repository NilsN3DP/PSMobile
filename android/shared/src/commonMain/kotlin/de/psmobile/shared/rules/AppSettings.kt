    ...
    val toggles: List<Toggle> = listOf(
        ...
        Toggle(
            ...
            why = Bilingual(
                ...
                // Der Knopf heisst auf Deutsch "Jetzt slicen" - so hiess er hier bis zum 16.09.2026 "Slice now".
                "Auf dem eigenen Server statt auf diesem Gerät slicen. Fügt einen Schalter neben „Jetzt slicen“ hinzu.",
            ),
            standard = true,
        ),
        Toggle(
