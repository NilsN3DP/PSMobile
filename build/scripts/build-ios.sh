...
# CMake 4 (Homebrew, seit 2026) lehnt Module mit cmake_minimum_required
# < 3.5 ab - PrusaSlicers FindOpenVDB.cmake ist so eines. Die Variable
# gilt als Umgebung fuer alle Aufrufe darunter; aeltere CMakes ignorieren
# sie. Auf dem Mac brach der erste Kernbau aus dem 1:1-Zweig am
# 12.09.2026 genau daran ab.
