...
struct SimpleObjectBarView: View {
    ...
    var body: some View {
        ...
        // Die Leiste als Ganzes, fuer Layouttests: ihre Knoepfe liegen
        // in einer waagerechten ScrollView, und XCUITest meldet auch fuer
        // weggescrollte Knoepfe einen Rahmen - der letzte Knopf endet so
        // bei 779, waehrend die Leiste selbst laengst bei 690 aufhoert.
        .accessibilityElement(children: .contain)
        .accessibilityIdentifier("objektleiste")
