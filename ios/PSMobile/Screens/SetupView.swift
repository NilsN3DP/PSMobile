...
struct SetupView: View {
    ...
    var body: some View {
        ...
        // Nachziehen, falls die Vorauswahl spaeter hereinkommt - nur
        // solange nichts gewaehlt ist, damit eine getroffene Wahl nicht
        // ueberschrieben wird.
        //
        // Gegen das eigentliche Problem half es nicht: `storedPrinters`
        // ist eine statische UserDefaults-Eigenschaft, an der kein
        // `onChange` haengt. Die Schalter wirken deshalb seit dem
        // 11.09.2026 in `PSMobileApp.init()`, vor dem ersten Bild.
        .onChange(of: preselected) { neu in
            if selected.isEmpty { selected = neu }
        }
    }
            ...
            VStack(alignment: .leading, spacing: ps.pt(2)) {
                ...
                if !tight {
                    Text(SimpleModeState.shared.text(
                            ...
                            german: "Wähle alle Drucker, die du nutzen willst."))
    ...
    private var suchfeld: some View {
        ...
        ZStack(alignment: .leading) {
            ...
            TextField("", text: $query)
                ...
                .accessibilityIdentifier("einrichtung.suche")
        }
    ...
    private var liste: some View {
        let alle = hersteller
        // Die Liste traegt denselben Namen wie drueben, damit beide
        // Seiten dieselbe Kennung benutzen - siehe SetupView.kt.
        return ScrollView {
        ...
        .frame(maxHeight: .infinity)
        .accessibilityIdentifier("einrichtung.liste")
    }
