            ...
            Button(action: onOpenSelection) {
                HStack(spacing: ps.pt(7)) {
                    ...
                    VStack(alignment: .leading, spacing: 1) {
                        ...
                        Text(objekteText(aktiv?.objectCount ?? 0))
                            ...
                            Button {
                                ...
                                HStack {
                                    ...
                                    VStack(alignment: .leading) {
                                        Text(model.bedLabel(bett.index))
                                            .fontWeight(.semibold)
                                        Text(objekteText(bett.objectCount))
                                            .font(.caption)
                                            .foregroundStyle(PrusaColors.textMuted)
                                    }
...
func objekteText(_ anzahl: Int) -> String {
    anzahl == 1 ? st("1 object", "1 Objekt") : st("\(anzahl) objects", "\(anzahl) Objekte")
}
