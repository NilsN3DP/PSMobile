...
final class SettingsUITests: XCTestCase {
    ...
    func testEinWertLaesstSichAendernUndBleibt() {
        ...
        // Die Schichthoehe, an ihrem Namen gegriffen. Bis zum
        // 11.09.2026 stand hier "das erste Textfeld der Seite" - das
        // trifft, solange niemand die Reihenfolge in tabs.json aendert,
        // und schweigt, wenn doch.
        let feld = app.textFields["feld.layer_height"]
        XCTAssertTrue(feld.waitForExistence(timeout: 5),
                      "Auf der ersten Seite fehlt die Schichthoehe")

        let vorher = feld.value as? String ?? ""
        XCTAssertFalse(vorher.isEmpty,
                       "Das Feld ist leer - der Wert kam nicht aus dem Kern")

        feld.ersetzeText("0.15\n")
