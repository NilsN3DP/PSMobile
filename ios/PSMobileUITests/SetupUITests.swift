...
final class SetupUITests: XCTestCase {
    ...
    func testDurchlaufDerErsteinrichtung() {
        ...
        XCTAssertTrue(core.waitForExistence(timeout: 30),
                      "Die Familienliste ist nicht erschienen")
    ...
    func testSucheBlendetDieGliederungAus() {
        XCTAssertTrue(app.buttons["familie.CORE"].waitForExistence(timeout: 30))
