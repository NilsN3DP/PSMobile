...
int main(int argc, char **argv)
{
    ...
    /* Die Annotationen entstehen oben nur unter PSM_TEST_MULTIPLE_BEDS_STATE
     * (paint_options_for braucht libslic3r-Header). Ohne den Merker wurde
     * nie gemalt - dann darf hier auch nichts erwartet werden. Bis zum
     * 14.09.2026 scheiterte der Android-Lauf genau an dieser Stelle. */
#if defined(PSM_TEST_MULTIPLE_BEDS_STATE)
    require(psm_model_paint_count(
