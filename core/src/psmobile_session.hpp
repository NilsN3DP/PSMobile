...
struct psm_session
{
    ...
    /*
     * libslic3r kennt data_dir() und resources_dir() nur prozessweit.
     * Mit zwei Sitzungen im selben Prozess - die App und der
     * eingebaute Selbsttest mit eigenem Ordner - zeigten die globalen
     * Pfade auf die zuletzt angelegte Sitzung; load_presets() der
     * anderen suchte dann im falschen Ordner ("psmdata/print: No such
     * file or directory", 12.09.2026, Selbsttest direkt beim Start).
     * Jede Sitzung stellt die globalen Pfade deshalb beim Eintritt in
     * eine ABI-Funktion auf ihre eigenen um. Die Zuweisung ist billig
     * und entfaellt, wenn sie schon stimmen.
     */
    void activate_dirs() const;
