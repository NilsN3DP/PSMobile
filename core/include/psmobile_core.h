...
/* 1, wenn dieser Kern STEP-Dateien lesen kann (OCCT eingebaut), sonst 0.
 * Die Apps fragen das hier ab, statt es fest anzunehmen - bis zum
 * 13.09.2026 behauptete Android STEP-Faehigkeit, die der Kern seit dem
 * 25.08. nicht mehr hatte. */
